(function ($) {
	"use strict";
	for (let i = 0; i < $('.btn-style-ten').length; i++) {
		$('.btn-style-ten').eq(i).click(function () {
			if ($('.btn-style-ten').eq(i).text() == "Read more") {
				$('.text-desc').eq(i).removeClass('d-none');
				$('.btn-style-ten').eq(i).text('Read less');

			} else {
				$('.text-desc').eq(i).addClass('d-none');
				$('.btn-style-ten').eq(i).text('Read more');

			}
		})
	}
	// $('.btn-style-ten').eq(0).click(function () {
	// 	if($('.btn-style-ten').eq(0).text()=="Read more"){
	// 		$('.text-desc').eq(0).removeClass('d-none');
	// 		$('.btn-style-ten').eq(0).text('Read less');

	// 	}else{
	// 		$('.text-desc').eq(0).addClass('d-none');
	// 		$('.btn-style-ten').eq(0).text('Read more');
