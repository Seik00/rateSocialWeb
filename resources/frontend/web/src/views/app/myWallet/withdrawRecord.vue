<template>
  <div class="main-content">
    <breadcumb :page="$t('withdraw')" :folder="$t('withdraw_record')" />

    <b-card :title="$t('withdraw_record')">
      <vue-good-table
        id="table"
        mode="remote"
      ...
      >
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-else-if="props.column.field == 'TRC20'">
            <span>
              TRC20
            </span>
          </span>
