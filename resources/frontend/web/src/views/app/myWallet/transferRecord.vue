<template>
  <div class="main-content">
    <breadcumb :page="$t('transfer')" :folder="$t('transfer_record')" />

    <b-card :title="$t('transfer_record')">
      <vue-good-table
        id="table"
        mode="remote"
  ...
  computed: {
    ...
    columns() {
      return [
        ...
        {
          label: this.$t("transfer_pin_to"),
          text: "to_user.username",
          field: "to_user.username",
          thClass: "gull-th-class",
          value: "to_user.username",
          sortable: false,
        },
        {
