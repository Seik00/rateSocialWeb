<template>
  <div class="main-content">
    <breadcumb :page="$t('orderList')" :folder="$t('tradeManage')" />
    <b-row>
      <b-col md="12">
        <b-card class="mb-30">
...
<script>
import { getOrderList } from "../../../system/api/api";
