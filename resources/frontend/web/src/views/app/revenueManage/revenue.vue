...
<script>
import { getTotalRevenue } from "../../../system/api/api";
...
export default {
  ...
  data() {
    return {
      ...
      canClear: false,
      rows: [],
      website:"/revenueManage/revenueDetails?date",
    };
  },
  props: ["success"],
  methods: {
    ...
    goToHome(){
      this.$router.push('/web/revenueManage/revenueDetails'); 
    },
    loadItems(start_date,end_date) {
      var result = getTotalRevenue(start_date,end_date);
      var self = this;
      this.isLoading = true;
      result
        .then(function (value) {
