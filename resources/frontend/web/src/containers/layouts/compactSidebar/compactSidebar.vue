      ...
      <ul class="navigation-left">
        ...
        >
          <a class="nav-item-hold" href="#">
            ...
            <span class="nav-text">三方授权API</span>
          </a>
          <div class="triangle"></div>
        </li>
        <li
        ...
        >
          <a class="nav-item-hold" href="#">
            ...
            <span class="nav-text">量化机器人</span>
          </a>
          <div class="triangle"></div>
        </li>
        <li
    ...
    >
      <div ref="sidebarChild">
          ...
          <ul class="childNav" data-parent="dashboards">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/dashboards/dashboard.v1">
                ...
                <span class="item-name">本站用户</span>
              </router-link>
            </li>
          </ul>
        </div>
          ...
          <ul class="childNav" data-parent="ui-kits">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/ui-kits/alerts">
                ...
                <span class="item-name">币种管理</span>
              </router-link>
            </li>
            ...
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/ui-kits/accordion">
                ...
                <span class="item-name">钱包列表</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/ui-kits/badges">
                <i class="nav-icon i-Medal-2"></i>
                <span class="item-name">转账记录</span>
              </router-link>
            </li>
          </ul>
        </div>
        ...
        >
          ...
          <ul class="childNav" data-parent="apps">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/extraKits/dropdown">
                <i class="nav-icon i-Arrow-Down"></i>
                <span class="item-name">第三方交易对</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/extraKits/imageCropper">
                <i class="nav-icon i-Crop-2"></i>
                <span class="item-name">授权API列表</span>
              </router-link>
            </li>
          </ul>
        </div>
          ...
          <ul class="childNav" data-parent="charts">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/charts/eChart">
                ...
                <span class="item-name">机器人列表</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/charts/eChart">
                <i class="nav-icon i-Line-Chart-2"></i>
                <span class="item-name">机器人订单</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/charts/eChart">
                <i class="nav-icon i-Line-Chart-2"></i>
                <span class="item-name">机器人日志</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/charts/eChart">
                <i class="nav-icon i-Line-Chart-2"></i>
                <span class="item-name">机器人收益</span>
              </router-link>
            </li>
          </ul>
        </div>
          ...
          <ul class="childNav" data-parent="widgets">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/widgets/widgetCard">
                ...
                <span class="item-name">激活码管理</span>
              </router-link>
            </li>
          </ul>
        </div>
          ...
          <ul class="childNav" data-parent="datatables">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/datatables/paging">
                ...
                <span class="item-name">钩子管理</span>
              </router-link>
            </li>
          </ul>
        </div>
          ...
          <ul class="childNav" data-parent="sessions">
            <li class="nav-item">
              <router-link tag="a" class to="/web/admin/sessions/signIn">
                ...
                <span class="item-name">任务日志</span>
              </router-link>
            </li>
          </ul>
        </div>
          ...
          <ul class="childNav" data-parent="pages">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/error">
                ...
                <span class="item-name">角色管理</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/profile">
                <i class="nav-icon i-Male"></i>
                <span class="item-name">管理员</span>
              </router-link>
            </li>
          </ul>
        </div>
        ...
        <div
          class="submenu-area"
          data-parent="doc"
          :class="{ 'd-block': selectedParentMenu == 'doc' }"
        >
          <header>
            <h6>系统管理</h6>
            <p>Lorem ipsum dolor sit.</p>
          </header>
          <ul class="childNav" data-parent="doc">
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/error">
                <i class="nav-icon i-Error-404-Window"></i>
                <span class="item-name">网站信息</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/profile">
                <i class="nav-icon i-Male"></i>
                <span class="item-name">邮箱配件</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/error">
                <i class="nav-icon i-Error-404-Window"></i>
                <span class="item-name">banner图管理</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/profile">
                <i class="nav-icon i-Male"></i>
                <span class="item-name">短信其他</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/error">
            ...
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/profile">
                <i class="nav-icon i-Male"></i>
                <span class="item-name">文件存储</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link tag="a" class to="/web/app/pages/profile">
                <i class="nav-icon i-Male"></i>
                <span class="item-name">运营配置</span>
              </router-link>
            </li>
          </ul>
        </div>
