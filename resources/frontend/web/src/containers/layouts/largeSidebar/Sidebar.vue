  ...
  >
    ...
    >
      <div ref="sidebarChild">
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/dashboards/dashboard.v1">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/dashboards/dashboard.v2">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/dashboards/dashboard.v3">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/dashboards/dashboard.v4">
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/basicForms">
              <i class="nav-icon i-File-Clipboard-Text--Image"></i>
              <span class="item-name">Basic Elements</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/formLayouts">
              <i class="nav-icon i-Split-Vertical"></i>
              <span class="item-name">Form Layouts</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/basicActionBar">
              <i class="nav-icon i-Receipt-4"></i>
              <span class="item-name">Basic Action Bar</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/formComponent">
              <i class="nav-icon i-Close-Window"></i>
              <span class="item-name">Form Validation</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/formWizard">
              <i class="nav-icon i-Width-Window"></i>
              <span class="item-name">Form Wizard</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/tagInput">
              <i class="nav-icon i-Tag-2"></i>
              <span class="item-name">Tag Input</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/mask">
              <i class="nav-icon i-Pen-2"></i>
              <span class="item-name">Form Mask</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/datepicker">
              <i class="nav-icon i-Calendar-4"></i>
              <span class="item-name">Datepicker</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/forms/V2Datepicker">
              <i class="nav-icon i-Calendar-4"></i>
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/datatables/paging">
              <i class="nav-icon i-Split-Four-Square-Window"></i>
              <span class="item-name">Paging</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/datatables/filter">
              <i class="nav-icon i-Split-Vertical"></i>
              <span class="item-name">Filter</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/datatables/list">
              <i class="nav-icon i-Split-Vertical"></i>
              <span class="item-name">List</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/datatables/vue-good-table">
        ...
        >
          ...
          >
            ...
            <ul class="submenu">
              <li>
                <router-link tag="a" class to="/web/app/apps/invoice">
                  <i class="nav-icon i-Files"></i>
                  <span class="item-name">Invoice List</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/apps/createInvoice">
                  <i class="nav-icon i-Add-File"></i>
                  <span class="item-name">Create Invoice</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/apps/printInvoice">
          ...
          >
            ...
            <ul class="submenu">
              <li>
                <router-link tag="a" class to="/web/app/apps/contact-list">
                  <i class="nav-icon i-File-CSV"></i>
                  <span class="item-name">Contact Lists</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/apps/contact-grid">
                  <i class="nav-icon i-File-CSV"></i>
                  <span class="item-name">Contact Grid</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/apps/contact-details">
                  <i class="nav-icon i-File-CSV"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/products">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name"
                >Ecommerce
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/taskManager">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">Task Manager</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/todo-list">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name"
                >Todo App
                <span class=" ml-2 badge badge-pill badge-danger"
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/contact-list-table">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name"
                >Contacts Table
                <span class=" ml-2 badge badge-pill badge-danger"
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/calendar">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/inbox">
              <i class="nav-icon i-Email"></i>
              <span class="item-name">Inbox</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/chat">
              <i class="nav-icon i-Speach-Bubble-3"></i>
              <span class="item-name">Chat</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/apps/scrumboard">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name"
                >scrumboard
                <span class=" ml-2 badge badge-pill badge-danger"
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/dropdown">
              <i class="nav-icon i-Arrow-Down"></i>
              <span class="item-name">Dropdown</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/imageCropper">
              <i class="nav-icon i-Crop-2"></i>
              <span class="item-name">Image Cropper</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/loaders">
              <i class="nav-icon i-Loading-3"></i>
              <span class="item-name">Loaders</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/sidebar">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/spinners">
              <i class="nav-icon i-Two-Windows"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/vueDraggable">
              <i class="nav-icon i-Two-Windows"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/avatar">
              <i class="nav-icon i-Two-Windows"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/calendar">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/rating">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/spinButton">
              <i class="nav-icon i-Circular-Point"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/datePicker">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/timePicker">
              <i class="nav-icon i-Over-Time"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/vueTree">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/toasts">
              <i class="nav-icon i-Bell"></i>
              <span class="item-name">Toastr</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/sweetAlerts">
              <i class="nav-icon i-Approved-Window"></i>
              <span class="item-name">Sweet Alerts</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/extraKits/tour">
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/alerts">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/accordion">
              <i class="nav-icon i-Split-Horizontal-2-Window"></i>
              <span class="item-name">Accordion</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/badges">
              <i class="nav-icon i-Medal-2"></i>
              <span class="item-name">Badges</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/buttons">
              <i class="nav-icon i-Cursor-Click"></i>
              <span class="item-name">Buttons</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/cards">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/bootstrap-tab">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/modals">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/collapsible">
              <i class="nav-icon i-Width-Window"></i>
              <span class="item-name">Collapsible</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/ui-kits/typography">
              <i class="nav-icon i-Width-Window"></i>
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/charts/eChart">
              <i class="nav-icon i-Line-Chart-2"></i>
          ...
          >
            ...
            <ul class="submenu">
              <li>
                <router-link tag="a" class to="/web/app/charts/apexAreaChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Area Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexBarChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Bar Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexLineChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Line Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexMixChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
              ...
              <li>
                <router-link tag="a" class to="/web/app/charts/apexColumnChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Column Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexPieDonutsChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Pie Donut Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexRadarChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Radar Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexRadialBarChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
                  <span class="item-name">Radial Bar Chart</span>
                </router-link>
              </li>
              <li>
                <router-link tag="a" class to="/web/app/charts/apexScatterChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
              ...
              <li>
                <router-link tag="a" class to="/web/app/charts/apexSparklineChart">
                  <i class="nav-icon i-Line-Chart-2"></i>
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/widgets/widgetCard">
              <i class="nav-icon i-Two-Windows"></i>
              <span class="item-name">Widget Card</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/widgets/widgetStatistics">
              <i class="nav-icon i-Windows-2"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/widgets/weatherApp">
              <i class="nav-icon i-Windows-2"></i>
              <span class="item-name">Weather App</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/widgets/widgetApp">
              <i class="nav-icon i-Windows-2"></i>
              <span class="item-name">App Widgets</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/widgets/widgetList">
              <i class="nav-icon i-Windows-2"></i>
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/admin/sessions/signIn">
              <i class="nav-icon i-Checked-User"></i>
              <span class="item-name">Sign in</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/sessions/signUp">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">Sign up</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/sessions/forgot">
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/pages/error">
              <i class="nav-icon i-Error-404-Window"></i>
              <span class="item-name">Not Found</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/pages/profile">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/pages/icons">
              <i class="nav-icon i-Male"></i>
              <span class="item-name">icons</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/pages/search-result">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/pages/pricing-table">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/web/app/pages/faq">
              <i class="nav-icon i-Billing"></i>
              <span class="item-name">
                Faq
                <span class="badge badge-pill badge-danger">New</span>
