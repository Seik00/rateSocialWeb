<template>
  <div class="main-content">
    <breadcumb :page="$t('walletRecord')" :folder="$t('record')" />
    <b-row>
      <b-col md="12">
        <b-card class="mb-30">
...
<script>
import { getWalletRecord } from "../../../system/api/api";
...
if(dHour.toString().length == 1){
    ...
    loadItems() {
      var result = getWalletRecord("special_bonus", this.searchUsername, this.from, this.to, this.pageNumber);
      var self = this;
      this.isLoading = true;
      result
        .then(function (value) {
